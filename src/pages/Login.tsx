...
export default function Login() {
  ...
  return (
    <div className="min-h-screen bg-gradient-subtle flex flex-col">
      {/* Header */}
      <div className="px-6 pt-16 pb-8 safe-top text-center">
      ...
      <div className="flex-1 px-6 max-w-lg mx-auto w-full">
        ...
        <div className="flex gap-3">
          <button className="flex-1 h-14 bg-card border border-border rounded-2xl flex items-center justify-center gap-2 hover:bg-muted transition-colors ios-bounce">
